...
Creators can now lock in logos, color palette, and typography once, and every generated asset will inherit those rules automatically.
...
- Data is stored alongside the Brand Brain profile (`data/brands/{user}.json`), and the design generation endpoint injects kit directives into every design prompt.
