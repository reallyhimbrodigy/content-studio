...
const SHORT_FORM_CONTENT_CONTRACT_BLOCK = [
  ...
  '- Style: TikTok/IG-native, entertaining-first, punchy, 15-25s, no intros.',
  ...
  '- Uniqueness: fresh phrasing, no repeated opening patterns across days, no reused CTA wording or boilerplate.',
  ...
  'Hook: viewer-centric pattern interrupt, 6-12 words if possible; ban salesy phrases ("reveals the secret", "dream home", "exclusive listings", "personalized service", "don\'t settle", "act fast", "ready to navigate"); falsifiable and specific.',
  'Caption: exactly one takeaway + exactly one concrete proof detail (single specific: timeline, constraint, price range, negotiation lever, inspection issue, HOA/flood zone/appraisal gap). No vague claims.',
  'Use the same single proof detail in Caption and Reel Script.',
