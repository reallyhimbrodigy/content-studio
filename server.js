...
12) Story Prompt: write 2–4 sentences describing exactly what to show and say in a Story for this post. Tie every sentence to the provided niche ({nicheStyle}) and the post’s unique concept; avoid “selfie story” scripts unless that best fits the angle. Do not reuse templates, repeated scaffolds, or category labels across cards. Output only the prompt text.
