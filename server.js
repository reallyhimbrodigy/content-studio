...
const REGULAR_CONTENT_QUALITY_RULES_BLOCK = [
  ...
  'VALIDATION & REWRITE (INTERNAL):',
  '- Silently scan the draft for banned language, testimonial framing, or repetition across sections.',
  '- If any violation is found, rewrite and rescan until compliant.',
  '- Do not mention this audit in the output; return only final JSON.',
].join('\n');
...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  '- CTA must not imply contact, messaging, scheduling, starting, buying, or access to exclusivity.',
  '- CREATOR EGO SUPPRESSION: No first-person authority framing (e.g., "I help", "my clients", "why choose me", "trust me").',
  '- Attack the belief, not the reader; no insults, no shaming.',
  'VALIDATION & REWRITE (INTERNAL):',
  '- Silently scan the draft for missing steps, hype framing, CTA violations, or repetition across sections.',
  '- If any violation is found, rewrite and rescan until compliant.',
  '- Do not mention this audit in the output; return only final JSON.',
  'HOOK VARIETY RULE:',
  '- Do not reuse the same hook phrasing across posts.',
