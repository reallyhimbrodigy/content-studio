...
const REGULAR_CALENDAR_CEILING_CONTRACT_BLOCK = [
  ...
  '- REGULAR — EDUCATION: teach a mistake + a simple fix, no deep mechanism.',
  '- REGULAR — SOCIAL PROOF: must include a specific metric + scenario; no vague "happy clients".',
  '- REGULAR — PROMOTION: connect offer/listing/service to a pain or decision moment; no feature dumping.',
  '- REGULAR — LIFESTYLE: must NOT be tourism/vibes; tie lifestyle to buying/selling triggers, timing, or tradeoffs.',
  '',
...
const BRAND_BRAIN_UNFAIR_ADVANTAGE_CONTRACT_BLOCK = [
  ...
  '- Ban openings like: "Unlock the secrets", "Curious about", "Witness the magic", "Miami is full of...".',
  '',
