...
const REGULAR_CALENDAR_CEILING_CONTRACT_BLOCK = [
  ...
  '',
  '3) ENGAGEMENT + CTA',
  '- Engagement prompt must be tied to the mechanism (A/B choice OR comment keyword).',
  ...
  '- Lifestyle: connect lifestyle to a practical consideration the audience cares about (cost/commute/amenities/resale/etc.) + one action step. No identity/priority reframes.',
  '',
...
const BRAND_BRAIN_UNFAIR_ADVANTAGE_CONTRACT_BLOCK = [
  ...
  '',
  '2) REEL SCRIPT / BODY (retention pacing)',
  '- 4-6 short beats, quick shifts.',
  '- Must embed the six strategic functions above inside the beats.',
