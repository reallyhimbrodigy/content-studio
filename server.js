...
const REGULAR_CONTENT_QUALITY_RULES_BLOCK = [
  ...
  '- BANNED RHETORIC (REGULAR ONLY): belief framing ("believe", "think", "assume", "myth", "truth is", "misconception", "bubble", "overpriced"), consequence/threat framing ("if you don\'t", "risk", "cost you", "miss out", "derail", "dangerous", "mistake", "failure", "don\'t let"), urgency/scarcity ("now", "before it\'s gone", "don\'t wait", "act fast", "disappearing", "snatched up", "limited"), superiority/insider framing ("hidden", "insider", "exclusive access", "secret", "only pros know"), adversarial/shaming tone ("you\'re doing it wrong").',
  ...
  '- CTA must be soft and informational; no coercive or pressuring language.',
...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  '- Why people hold it (psychological driver or assumption).',
  ...
  '- BANNED BRAND BRAIN FRAMING: empty edginess without causal reasoning, generic motivational slogans, vague "game changer" claims without mechanism.',
  ...
  '- CTA must be direct but non-spammy; align it to the belief teardown and specificity. Must not repeat the Hook. No location/industry terms unless present in inputs.',
  'HOOK VARIETY RULE:',
  '- Do not reuse the same hook phrasing across posts.',
