...
const SHORT_FORM_CONTENT_CONTRACT_BLOCK = [
  ...
  '- Hook must stop scroll in the first 1-2 seconds with curiosity, contrast, or specificity (no vague openers).',
  '- Retention pacing: visible beat shifts every ~2-3 seconds (pattern interrupt, quick contrast, numbered beats, rapid examples).',
  ...
  'Caption: short lines (5-8 lines). Use 3-5 tight beats with one concrete example and one proof detail; no fixed before/pivot skeleton.',
...
const REGULAR_CALENDAR_CEILING_CONTRACT_BLOCK = [
  ...
  '- Provide 3 practical actions/checkpoints plus 1 concrete example; keep them surface-level.',
...
const BRAND_BRAIN_UNFAIR_ADVANTAGE_CONTRACT_BLOCK = [
  ...
  '- EDUCATION: show why surface cost/price focus fails; replace with mechanism + sequence + consequence.',
  '- PROMOTION: make the advantage about decision sequence and access mechanics, not hype.',
  '- SOCIAL PROOF: tie the result to the mechanism and state what would have happened otherwise.',
  '- LIFESTYLE: reframe priorities tied to the outcome and state a second-order consequence.',
  '',
  'BRAND BRAIN BANS:',
