...
function buildBrandBrainDirective(settings = {}) {
  ...
  const lines = [
    'Brand Brain mode: sharper, more sales-psych forward than Regular.',
    '- Use contrarian / myth / "stop doing X" angles to create tension.',
    '- Avoid step-by-step checklists or \"how-to\" lists. Imply the method; do not teach it fully.',
    '- Hooks must be specific and curiosity-inducing; no generic openers.',
    '- Captions should read like POV, concise and direct.',
    '- EngagementScripts must include a DM keyword and a clear next-step follow-up (commentReply + dmReply).',
...
const QUALITY_ALIGNMENT_BLOCK = [
  ...
  '- Title, Hook, Caption, Reel Script Body, Engagement Loop, and Distribution Plan must not repeat or paraphrase each other.',
...
const REGULAR_CONTENT_QUALITY_RULES_BLOCK = [
  ...
  '- BANNED RHETORIC (REGULAR ONLY): belief framing, consequence/threat framing, urgency/scarcity, exclusivity/insider framing, superiority claims, aspirational lifestyle selling, outcome/benefit promises, adversarial/shaming tone.',
  '- REGULAR MUST NOT contain: urgency/scarcity, aspiration or promise framing, sales framing, persuasion scaffolding, or conversion intent.',
  '- Disallowed patterns in Regular: "don’t miss", "act now", "before it’s gone", "limited", "exclusive access", "unlock", "dream", "perfect", "ideal", "game changer", "life-changing", "upgrade", "DM me", "reach out", "contact", "book", "buy/sell" language, "this shows why", "importance of", "prove", "trust me", "you need", "discover", "explore", "learn more".',
  ...
  '- Engagement loop must be courteous and informational; no selling, no pressure.',
  ...
  '- CTA: 4–8 words, informational, non-transactional. No location/industry terms unless present in inputs.',
  ...
  '- Must be a factual sequence: context → constraints → actions → result, stated without evaluative adjectives.',
  '- Must not include testimonial-style language or persuasive framing.',
  ...
  '- Before finalizing output, verify: Regular Calendar content contains NO persuasion or positioning language. If not, revise until compliant.',
].join('\n');
...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  '- CTA must be direct but non-spammy; align it to continuing the reasoning process or requesting the diagnostic next step. No urgency, scarcity, or exclusivity framing. Must not repeat the Hook. No location/industry terms unless present in inputs.',
...
` : '';
  const brandBrainAddendum = opts.brandBrainDirective
    ? [
      ...
      '- Keep output sharp and persuasive without changing the topic.',
