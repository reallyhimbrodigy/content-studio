...
const REGULAR_CALENDAR_CEILING_CONTRACT_BLOCK = [
  ...
  '  * Include exactly ONE concrete mechanism (cause -> effect).',
  '  * Include exactly ONE immediate action step.',
  '  * Include exactly ONE specific proof detail tied to the mechanism.',
...
const BRAND_BRAIN_UNFAIR_ADVANTAGE_CONTRACT_BLOCK = [
  ...
  '- The hook/body/reelScript/caption MUST explicitly include all six elements above as natural sentences.',
