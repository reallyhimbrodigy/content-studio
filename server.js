...
function buildBrandBrainDirective(settings = {}) {
  ...
  const lines = [
    ...
    '- Avoid step-by-step checklists or \"how-to\" lists. Imply the method; do not teach it fully.',
...
const QUALITY_ALIGNMENT_BLOCK = [
  ...
  '- Hook: 1 sentence. Topic orientation only. No CTA language.',
  '- Caption: adds new factual explanation not in the Hook. 2–4 sentences max.',
  '- reelScript.hook must match the Hook verbatim.',
  '- reelScript.body must add mechanisms, examples, or reasoning not already in the Caption.',
  '- CTA: neutral descriptive statement; no requests or action language; do not repeat Hook/Caption phrasing.',
  '- engagementScripts.commentReply: neutral statement tied to the post angle; no direct requests or questions.',
  '- engagementScripts.dmReply: neutral informational follow-up; no contact/action language; no questions; must not paraphrase Hook/Caption/Script.',
...
const REGULAR_CALENDAR_CEILING_CONTRACT_BLOCK = [
  ...
  '- CTA: one neutral descriptive line tied to the post intent (no action language).',
...
const REGULAR_CONTENT_QUALITY_RULES_BLOCK = [
  ...
  '- Disallowed Regular tokens (non-exhaustive): "don\'t miss", "act now", "before it\'s gone", "limited", "exclusive", "unlock", "dream", "perfect", "ideal", "game changer", "life-changing", "transform", "upgrade", "luxury", "must-see", "prime", "upscale", "stunning", "breathtaking", "unparalleled", "best", "amazing", "DM me", "reach out", "contact", "book", "buy", "sell", "schedule", "sign up", "visit", "check out", "discover", "explore", "learn more", "click", "tap", "watch", "follow", "comment", "share", "go live", "start", "get".',
  '- No CTA/action language anywhere in any field (including engagementScripts, distributionPlan, and hashtags).',
  '- No question marks anywhere in any field.',
  ...
  '- All hooks must be neutral topic statements or questions, not pitches.',
  ...
  'CTA LIMITATION:',
  '- CTA must be a single neutral line. No urgency, no pressure, no implied loss.',
  '- CTA must be soft and informational, non-transactional, and must not reference the creator.',
  '- CTA must not imply contact, messaging, scheduling, starting, buying, or exclusivity.',
  '- CTA must be a neutral descriptive statement about understanding or observation, not a request to contact or transact.',
  '- Hashtags must be descriptive only; no CTA/action tokens.',
  '- Engagement loop must be neutral and informational; no direct requests, no questions, no selling, no pressure, no DM prompts.',
  ...
  '- Caption: 2–4 sentences; must add 2 concrete facts or angles not stated in Hook.',
  '- ReelScript.body must add 2 additional concrete points or examples not stated in Hook/Caption; no paraphrasing.',
  '- CTA: 4–8 words, informational, non-transactional, and non-imperative. No location/industry terms unless present in inputs.',
  '- Each section must end with a neutral declarative statement; no suggestions or prompts.',
  ...
  '- Must be a factual sequence: context → constraints → actions → result, stated plainly without praise or evaluation.',
  '- Must not include testimonial language, endorsements, quotes, or emotional/praise wording.',
  ...
  '- Promotion must explain evaluation criteria or comparison factors; no selling or action requests.',
  ...
  '- No CTA language anywhere (including Engagement Loop, Distribution Plan, and hashtags).',
...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  'REQUIRED 5-PART STRUCTURE (MANDATORY):',
  ...
  'Each post must explicitly include all five steps above; keep all parts aligned to the post title and niche.',
  ...
  '- Disallowed Brand Brain tokens (non-exhaustive): "discover", "explore", "unlock", "act now", "don\'t miss", "dream", "perfect", "transform", "game changer", "life-changing", "upgrade", "DM me", "reach out", "contact", "book", "buy", "sell", "schedule", "sign up", "visit", "check out", "learn more", "click", "tap", "watch", "follow", "comment", "share".',
  '- No CTA/action language anywhere (including engagementScripts and distributionPlan).',
  '- No question marks anywhere in any field.',
  '- No advisory verbs or instruction framing (e.g., "consider", "remember", "make sure", "try", "focus on", "you should", "you need to", "don\'t", "avoid", "act", "start").',
  ...
  '- Decision reversal must be explicit in the output.',
  '- Contrarian framing and cognitive reframing are required.',
  '- ReelScript.body must include all five components in order: false belief (1 sentence), why it feels true (1 sentence), hidden constraint (1 sentence), concrete consequence (1 sentence), reframed truth (1 sentence). If any component is missing, rewrite until all five are explicit.',
  ...
  '- CTA fields are required by schema; cta, script.cta, reelScript.cta must be non-empty neutral descriptive lines with no action language or contact prompts. Must not repeat the Hook.',
  '- Hashtags must be descriptive only; no CTA/action tokens.',
  '- CREATOR EGO SUPPRESSION: No first-person authority framing (e.g., "I help", "my clients", "why choose me", "trust me").',
  ...
  '- Contains explicit causal chain: belief -> why it feels true -> hidden constraint -> consequence -> reframed truth.',
  '- Exactly one belief is addressed; no blending.',
  '- Reframed truth is analytical and model-based, not advice or promotion.',
  '- No CTA/action language anywhere (including engagementScripts, distributionPlan, and hashtags).',
  ...
  '- Pillar content must match its pillar label; no cross-pillar drift.',
  '- Social Proof must be an evidence chain: belief held → decision/process → observed outcome, stated plainly without praise.',
