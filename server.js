...
const REGULAR_CONTENT_QUALITY_RULES_BLOCK = [
  ...
  'The Regular Calendar is a neutral execution engine.',
  ...
  '- Regular Calendar outputs must NOT contain: "exclusive", "hidden", "you\'re missing out", "stop believing", "think again", "most people", "big mistake", "huge mistake", "secret", "strategy", "framework", "system", "most buyers/sellers fail", "what others don\'t tell you".',
  ...
  '- Hooks must be phrased as one of: "What buyers are asking about X", "How X is changing in Miami", "What to expect when...".',
  'CAPTION RULE (ANTI-REDUNDANCY):',
  '- The caption must NOT restate the reel script. It may add context, clarification, or a summary insight, but must not duplicate sentences from the reel.',
  'CTA LIMITATION:',
  '- CTAs must be limited to: "Comment", "DM", "Learn more". No urgency, no pressure, no implied loss.',
...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  'Brand Brain content exists to differentiate the creator.',
  'It must express a point of view, challenge assumptions, and introduce risk or opportunity cost.',
  'REQUIRED 4-PART STRUCTURE (MANDATORY):',
  '- Challenged belief: a commonly held assumption in the niche.',
  '- Why that belief fails in THIS market + Miami-specific constraint (costs, competition, regulations, behavior).',
  '- Concrete consequence: what goes wrong if the belief is followed (money, time, leverage, stress).',
  '- Alternative behavior: what to think about or check instead (not a generic "work with me").',
  '- If any element is missing, rewrite until all four are present.',
  'OPENING DIVERSITY RULE:',
  '- Brand Brain hooks must NOT repeatedly start with the same phrase.',
  '- Avoid overuse of: "Stop believing...", "Think again...", "Hidden costs...", "Most people...".',
