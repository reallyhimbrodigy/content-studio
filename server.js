...
function buildPrompt(nicheStyle, brandContext, opts = {}) {
  ...
  const BRAND_BRAIN_ALL_FIELDS_PROMPT = [
    ...
    '- Fail if: includes hook/body copy or labels.',
    '- Example shape: "{CTA LINE}"',
    'Formatting Contract (reelHook/reelBody/reelCta):',
    '- Do NOT use quotation marks of any kind (no ", \', “ ”, ‘ ’).',
    '- Do NOT use exclamation marks.',
    '- Do NOT prefix the text with labels like “Hook:”, “Body:”, “CTA:”, “Reel Script:”.',
    '- Output plain text only in each field; no markdown, no bullets unless explicitly asked by the field.',
    '- Use clean sentences; end with a period or no punctuation.',
    '- Do not include niche/location terms unless provided via input variables.',
    'Brand Brain Reel Script exemplar (format only):',
    'Hook exemplar: Lost my dream home because I waited one day.',
    'Body exemplar: The hidden step is getting clarity before you tour. Here is how to avoid it.',
    'CTA exemplar: Comment GUIDE and I will send the checklist.',
