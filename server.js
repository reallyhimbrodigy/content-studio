...
function buildBrandBrainDirective(settings = {}) {
  ...
  const lines = [
    ...
    'Single intent rule: Pick ONE primary intent per post (SAVE or COMMENT or SHARE). Hook, Reel Script, Caption, CTA, Engagement Loop, and Distribution Plan must align to that single intent and the chosen archetype; no mixed intents.',
    ...
    'Proof requirement: include at least 2 concrete, niche-specific proof points (examples, constraints, tradeoffs, or actionable checks).',
    ...
    'Brand Brain self-check (silent): before finalizing each post, ensure hook specificity, archetype alignment, single-intent consistency, 2+ proof points, no generic opener, and CTA aligned to intent.',
