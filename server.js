...
const QUALITY_ALIGNMENT_BLOCK = [
  ...
  '- engagementScripts.commentReply: one specific follow-up question tied to the post angle; no repetition of Hook/Caption/Script.',
  '- engagementScripts.dmReply: clear next step; must not restate the CTA verbatim or paraphrase Hook/Caption/Script.',
  '- designNotes, engagementScripts, and distributionPlan must add distinct information; do not restate Hook/Caption/Script.',
  '- distributionPlan: generic platform placement guidance only; no Hook/CTA language or persuasion.',
].join('\n');
...
const REGULAR_CONTENT_QUALITY_RULES_BLOCK = [
  ...
  '- CTA must be soft and informational, not transactional; no direct-response prompts (no DM, schedule, buy, sell, act-now).',
  ...
  '- CTA: action-only, 4–8 words. Must be a single concrete next step with a deliverable. No location/industry terms unless present in inputs.',
...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  '- BANNED BRAND BRAIN FRAMING: empty edginess without causal reasoning, generic motivational slogans, vague mechanism-free claims.',
