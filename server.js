...
const LIFESTYLE_REDEFINITION_BLOCK = [
  ...
  '- Lifestyle posts must be "decision-support lifestyle" tied to purchase/sale triggers, financial tradeoffs, or identity-based decision pressure.',
...
const REGULAR_CALENDAR_CEILING_CONTRACT_BLOCK = [
  ...
  '- Provide 2-3 actionable tactics, but keep them surface-level.',
  '- If the required "Before/Pivot/Steps/Proof" format is used, the "Before" must include a specific mistake and the "Proof" must include a specific measurable outcome.',
  ...
  '- Avoid belief-correction framing (no "you think X but..." style). Keep tone observational, practical, helpful.',
  '- Avoid making unseen blockers, decision sequence changes, or downstream consequences the core persuasion device.',
  '- Avoid inevitability framing or objection pre-removal tactics; stay surface-level persuasive.',
  '- Explicitly AVOID revealing:',
  '  - sequencing ("do this first, then...")',
  '  - hidden levers',
  '  - conversion psychology',
  '  - algorithm exploitation mechanics',
  '- End each post leaving a curiosity gap: viewer feels "I know what matters, but I\'m missing the real system."',
  '',
  'REGULAR PILLAR SHAPING:',
  '- REGULAR — EDUCATION: teach a concrete mechanism or process step with a simple takeaway; no deep reframing.',
  '- REGULAR — SOCIAL PROOF: short outcome story with specific details; no mindset/decision reframing.',
  '- REGULAR — PROMOTION: promote clear offer/access/value; benefit-led and straightforward.',
  '- REGULAR — LIFESTYLE: connect lifestyle to a tangible business outcome or decision trigger; keep it practical.',
  '',
...
const BRAND_BRAIN_UNFAIR_ADVANTAGE_CONTRACT_BLOCK = [
  ...
  '- EDUCATION: dismantle a misconception via mechanism + downstream consequence.',
  '- PROMOTION: reframe timing/access/advantage with a sequence change and clear leverage.',
  '- SOCIAL PROOF: make the outcome feel causally inevitable and state what would have happened otherwise.',
  '- LIFESTYLE: reframe priorities/identity tied to the outcome and state a second-order consequence.',
  '',
  'BRAND BRAIN BANS:',
