...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  '- ReelScript.body must include all six components in order: false belief (1 sentence), why it feels true (1 sentence), hidden constraint (1 sentence), concrete consequence (1 sentence), reframed truth (1 sentence), tiny action (1 sentence). If any component is missing, rewrite until all six are explicit.',
  '- Integrate the scenario example and objection + answer into the body without breaking the six-step chain.',
