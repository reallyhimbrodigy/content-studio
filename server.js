...
const SHORT_FORM_CONTENT_CONTRACT_BLOCK = [
  ...
  '- 6-11 words OR one short question (max 10 words).',
  '- 7–12 words. Must open a loop. Must include a concrete detail (number/threshold/place/scenario). Must not be a broad generic question.',
  '- Must introduce tension, surprise, or a specific angle from the title/topic.',
  ...
  '- 15–20 seconds, 90–140 spoken words. One idea only. Must include 2–3 fast, concrete points. Must include one “common mistake” or “watch out” line. Must not include intros or scene-setting. Must not end with vague “want to know more” language.',
  '- Output script as 3 labeled lines ONLY: "Hook:", "Body:", "CTA:".',
  '- Hook line: 1 sentence, 6-11 words (matches hook idea, not necessarily identical text).',
  '- Hook line must include the title\'s key nouns (see Title-Anchor Echo).',
  '- Body: 2-3 sentences total, max 45 words. No lists. No "Here are X reasons".',
  '- Body must include 1 specific detail tied to the title and 1 micro-moment of contrast (before/after, myth/truth, mistake/fix).',
  '- CTA: 2-5 words, platform-native, and must vary across posts.',
  ...
  '- 1-2 lines max. Total 140-220 characters.',
  ...
  '- Keep Format as-is.',
  '- Posting time tip: max 1 short sentence. If you don\'t have a strong tip, omit posting time tip entirely (do not invent).',
  'ENGAGEMENT LOOP (field: engagementScripts):',
  '- Output plain text with exactly three lines:',
  '  "Comment: ..." (1 sentence, <= 18 words, must reference a specific noun from the title)',
  '  "DM: ..." (1 sentence, <= 18 words, no salesy fluff)',
  '  "Follow up: ..." (1 short action, <= 12 words, content-based)',
  'Comment prompt must be forced-choice OR a specific scenario question OR a keyword request tied to a concrete deliverable. Avoid generic engagement asks.',
  '- Do not use repeated openers or filler like "Thanks for your interest".',
  'DISTRIBUTION PLAN (field: distributionPlan):',
  '- 2 lines max.',
  '- Each line must follow: "<Platform>: <specific action>."',
  '- No generic phrases without a tactic (pin, poll, remix, reply cadence, follow-up post type).',
  'DESIGN NOTES (field: designNotes):',
  '- Must be timestamped beats for 0–2s, 2–6s, 6–14s, 14–20s.',
  '- Each beat: 1 short sentence. No extra commentary.',
  '- Include on-screen text for the hook, limited to 3–5 words.',
  '- Avoid generic instructions unless tied to the topic.',
