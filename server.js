...
function buildBrandBrainDirective(settings = {}) {
  ...
  const lines = [
    ...
    '- Social Proof (Brand Brain structure required; use ONLY Instant Hooks, Tips/Tools/Hacks, or Beginners/How-To archetypes):',
    ...
    '  - Mechanism + validation: introduce a real result only as proof, not the headline. Explain the causal chain (what variable changed, in what order, why that sequence worked psychologically or algorithmically). Contrast what most people do vs what actually worked.',
    '  - Copyable framework (mandatory): provide a reusable structure (listing sequence, ad creative framework, or messaging checklist) the viewer can apply immediately for their next ad or listing.',
    ...
    '- EDUCATION — Brand Brain (Belief-Correction)',
    ...
    '  - Replace lists with a causal model:',
    ...
    '- LIFESTYLE — Brand Brain (Decision-Framing)',
    '  1. Hook (first 1–2 seconds)',
    ...
    '    - rush decisions',
    '    - delay action',
    '  - Position expertise as the filter that prevents these mistakes.',
    '  4. Copyable insight',
