...
function buildBrandBrainDirective(settings = {}) {
  ...
  const lines = [
    ...
    'Use a strong 0-3s hook optimized for the first 1-2 seconds, a mid re-hook at ~5-7s, and a loopable ending that re-opens the hook.',
    'Rotate hook archetypes across the month: Beginners & How-To (teaching + simplifying), Instant Hook Hooks (pattern interrupt), Tips/Tools/Hacks (practical value), Storytelling & Mindset (human lesson). Balance variety and avoid repeating the same structure back-to-back.',
    'Hook, script, caption, CTA, engagement loop, and distribution plan must reinforce the same core angle and intended action (save/share/comment).',
    'Bias toward save/share value: checklists, steps, do-this-instead, quick wins, mistakes to avoid, simplified frameworks.',
    'Bias toward comment value: easy-to-answer questions or A/B choices; use "comment X for Y" only when it fits the niche and avoids spammy language.',
    'When using Storytelling & Mindset, include a short personal lesson or failure-to-learning shift.',
    'Quality gates: no repeated hook structures on adjacent posts; avoid generic openers like "Did you know" or "Here are tips" unless highly specific; keep hooks punchy; CTA must match the intent and pillar goal.',
    'No vague motivational filler; keep everything niche-grounded and specific.',
