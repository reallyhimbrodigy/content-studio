...
const QUALITY_ALIGNMENT_BLOCK = [
  ...
  '- If any section repeats or echoes another section, rewrite until all sections are distinct.',
  ...
  '- CTA: non-transactional; do not repeat Hook/Caption phrasing.',
  '- engagementScripts.commentReply: one reflective question tied to the post angle; no repetition of Hook/Caption/Script.',
  '- engagementScripts.dmReply: informational next step; must not restate the CTA verbatim or paraphrase Hook/Caption/Script.',
  '- designNotes, engagementScripts, and distributionPlan must add distinct information; do not restate Hook/Caption/Script.',
  '- distributionPlan: posting mechanics only; no Hook/CTA language or persuasion.',
].join('\n');
...
const REGULAR_CALENDAR_CEILING_CONTRACT_BLOCK = [
  ...
  '- CTA: one neutral continuation line tied to the post intent.',
...
const REGULAR_CONTENT_QUALITY_RULES_BLOCK = [
  ...
  '- Disallowed Regular tokens (non-exhaustive): "don\'t miss", "act now", "limited", "exclusive", "unlock", "dream", "perfect", "ideal", "game changer", "life-changing", "transform", "upgrade", "stunning", "breathtaking", "unparalleled", "best", "amazing", "DM me", "contact", "book", "buy", "sell", "schedule", "sign up", "visit", "discover", "explore", "learn more", "click", "start", "get".',
  ...
  '- CTA must be a neutral continuation prompt about understanding or observation, not a request to contact or transact.',
  '- Engagement loop must be neutral, question-driven, and informational; no selling, no pressure, no DM prompts.',
  ...
  '- If any item fails, rewrite only the failing parts and rescan.',
  ...
  '- No CTA language anywhere (including Engagement Loop and Distribution Plan).',
...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  '- Disallowed Brand Brain tokens (non-exhaustive): "discover", "explore", "unlock", "act now", "don\'t miss", "dream", "perfect", "transform", "game changer", "life-changing", "upgrade", "DM me", "contact", "book", "buy", "sell", "schedule", "sign up", "visit".',
  ...
  '- CTA must be direct but non-spammy; align it to continuing the reasoning process. No urgency, scarcity, or exclusivity framing. Must not repeat the Hook. No location/industry terms unless present in inputs.',
  '- CTA must be neutral and non-action; no contact, messaging, scheduling, buying, or exclusivity.',
  '- CREATOR EGO SUPPRESSION: No first-person authority framing (e.g., "I help", "my clients", "why choose me", "trust me").',
  ...
  '- Reframed truth is analytical, not persuasive or promotional.',
  '- No CTA/DM/urgency/exclusivity language anywhere.',
  '- No repeated ideas or paraphrases across sections.',
  '- Hook supports the Title without repeating the Title wording.',
  '- If any check fails, rewrite until clean; never output a best-effort draft with violations.',
  'HOOK VARIETY RULE:',
