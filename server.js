...
const SHORT_FORM_CONTENT_CONTRACT_BLOCK = [
  ...
  'Each reply must be 1–2 complete sentences, <= 180 characters, and include a concrete comment trigger or A/B choice tied to the post.',
  ...
  'ReelScript: beat-based lines; Hook line must match Hook exactly; then 3 short body beats + CTA line. Structure: 0-2s hook, 2-6s stakes/contrast, 6-14s practical beats or mechanism, 14-20s payoff + CTA. For testimonials/social proof, require one specific moment; ban "happy client" / "personalized service".',
...
const REGULAR_CALENDAR_CEILING_CONTRACT_BLOCK = [
  ...
  '- Provide 3 practical actions/checkpoints plus 1 concrete example; include one concrete mechanism and one action step.',
...
const BRAND_BRAIN_UNFAIR_ADVANTAGE_CONTRACT_BLOCK = [
  ...
  '- Hooks must vary across posts (hyper-specific scenario, counterintuitive observation, contrast, stakes, or curiosity). Avoid "think again" / "you think" trope hooks.',
  '',
