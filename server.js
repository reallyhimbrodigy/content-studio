...
const SHORT_FORM_CONTENT_CONTRACT_BLOCK = [
  ...
  '- Script Hook line must not be identical to the hook field; same idea, different wording.',
  ...
  'TITLE (internal): Title must not be a topic label. It must encode the angle + promise (what changes for the viewer).',
  'Titles that begin with "Understanding," "Exploring," "Overview," "Guide," or other topic-framing wording are not allowed.',
  'Title must imply a decision, risk, or mistake (not a topic label).',
  ...
  '- First spoken line. 7–12 words. Must create tension (invalidate a common assumption OR warn about a mistake OR reveal a consequence). No "What are..." questions. Must include a concrete detail when possible (number/threshold/place/scenario).',
  ...
  '- 15–20 seconds, 90–140 spoken words. No intros.',
  '- Structure: (1) hook line, (2) who it’s for + promise, (3) 2–3 concrete points, (4) one common mistake/watch-out line, (5) one decisive action line.',
  ...
  '- Include exactly one line that is either "do this instead" or "avoid this" (worded naturally; do not label it).',
  '- Output script as 3 labeled lines ONLY: "Hook:", "Body:", "CTA:".',
  ...
  '- Optional: 1 short CTA at end (max 4 words); vary CTAs across posts.',
  ...
  '- CTA must segment the audience (forced choice OR keyword tied to a specific follow-up deliverable). No opinion-fishing.',
  'EXECUTION NOTES (field: executionNotes):',
  '- Specify production choices that affect retention: talking head vs voiceover, cut pace, on-screen text length (3–5 words), and when the "mistake reveal" happens (timestamp).',
  'ENGAGEMENT LOOP (field: engagementScripts):',
  '- Output plain text with exactly three lines:',
  '  "Comment: ..." (1 sentence, <= 18 words, forced choice OR specific constraint question tied to the title)',
  ...
  'Follow-up/DM line must promise a specific outcome (checklist, breakdown, comparison, rule-of-thumb). Generic "happy to help / let’s discuss your questions" language is not allowed.',
  'Avoid generic "DM me for more info" phrasing.',
  '- Do not use repeated openers or filler like "Thanks for your interest".',
  'DISTRIBUTION PLAN (field: distributionPlan):',
  '- Platform-specific framing: TikTok gets a stronger opening text overlay; Instagram includes a story reshare prompt using a forced-choice poll. Keep it 1–2 lines per platform.',
  'DESIGN NOTES (field: designNotes):',
  '- Provide beat-by-beat 0–20s shots tied to script lines. Each beat includes time range + shot + on-screen text that adds meaning (not a repeat). No generic skyline/graph filler unless it directly supports a point.',
  '- Every visual beat must either reinforce risk, clarify a choice, or contrast two options.',
  '- Decorative filler beats (skyline/graph "just because") are not allowed unless they directly support a point.',
  '- Keep beat-by-beat aligned to the script.',
  ...
  '- Story prompts must help viewers self-identify (buyer vs seller, condo vs house, timeline, budget band, priority constraint).',
  '- Open-ended opinion prompts ("what trends have you noticed...") are not allowed.',
  ...
  '- Script is 3 labeled lines (Hook/Body/CTA) and fits 15–20 seconds.',
...
` : '';
  const brandBrainAddendum = opts.brandBrainDirective
    ? [
        ...
        '- Title must not be a topic label. It must encode the angle + promise (what changes for the viewer).',
        '- Titles that begin with "Understanding," "Exploring," "Overview," "Guide," or other topic-framing wording are not allowed.',
        '- Title must imply a decision, risk, or mistake (not a topic label).',
