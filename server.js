...
const SHORT_FORM_CONTENT_CONTRACT_BLOCK = [
  ...
  '- Do NOT invent any industry/profession terms (e.g., real estate, agent, condo, listing, market) unless explicitly present in the inputs.',
  ...
  '- The word "market" is forbidden unless it appears verbatim in the inputs.',
...
const REGULAR_CONTENT_QUALITY_RULES_BLOCK = [
  ...
  '- Ban filler openers in Hook/CTA: "Discover", "Explore", "Let\'s dive", "Understanding X is essential", "Learn more", "Visit our website", "today", "now".',
  ...
  '- Reel body: must add 2 additional concrete details not stated in Caption; no paraphrasing.',
  '- CTA: action-only, 4–8 words. No banned filler words. No location/industry terms unless present in inputs.',
