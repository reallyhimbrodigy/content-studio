...
const BRAND_BRAIN_DIFFERENTIATION_RULES_BLOCK = [
  ...
  '- Why people hold it (psychological driver or assumption) and the hidden constraint or ignored variable that makes it fail.',
  ...
  'Each post must explicitly include all four steps above; keep all parts aligned to the post title and niche.',
  ...
  '- ReelScript.body must include all four components in order: false belief (1 sentence), why people hold it (1 sentence), concrete consequence (1 sentence), reframed truth (1 sentence). If any component is missing, rewrite until all four are explicit.',
