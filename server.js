...
function buildPrompt(nicheStyle, brandContext, opts = {}) {
  ...
  const GLOBAL_RULES = [
    ...
    '- NEVER output labels in content (no "HOOK:", "BEAT_", "BODY:", "CTA:", "ON_SCREEN_TEXT:", "BROLL_NOTES:", "Reel Script:").',
    ...
    '- onScreenText is short fragments reinforcing stakes; no definitions.',
