...
/** Convenience predicate. Use validateAgenticPlan when you want the reason. */
function isAgenticPlan(value) { return validateAgenticPlan(value).ok; }
...
module.exports = {
  PLAN_ID_RE, MAX_ENTRIES, validateAgenticPlan, isAgenticPlan, isHandlerRecipe,
};
