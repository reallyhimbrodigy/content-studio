...
// EMPTY = nothing pending. Add a column here the moment you author its migration
// (the gate then forces a `migration-guarded[<col>]` marker + fallback on every
// server.js reference); REMOVE it once the migration is confirmed applied AND the
// fallbacks are cleaned up. (demo/ask/post_package applied + cleaned 2026-07-26.)
const PENDING = [];
