...
const { tierIsMetered, METERED_TIERS, TIER_ALLOWANCE, COST_PER_RENDER,
        creditTierFor } = require('./credits');
...
assert.strictEqual(tierIsMetered('pro'), false,
  'PRO IS NOT METERED. All three Pro listings say Unlimited — "Unlimited '
