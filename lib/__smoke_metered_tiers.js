...
// MOVED 3 -> 1 WITH THE GRANT, 2026-09-22. Free went to one video a month and
// ten credits; 10 / 10 is 1. The old 3 is kept in this sentence because the
// number moved within a day of being set and the next reader deserves to know
// that rather than to meet a clean constant.
//
// It also CORROBORATES the change from a direction nothing forced: VIDEOS_LIMIT
// .free is separately ruled at 1, and the credit arithmetic independently lands
// on 1. Recorded as an agreement, NOT wired as an assertion between them — the
// comment beside VIDEOS_LIMIT refuses that deliberately, because the two are
// different quantities that happen to coincide and a rule would fail on the day
// they are correctly parted.
assert.strictEqual(TIER_ALLOWANCE.free / COST_PER_RENDER, 1);
