...
function purchaseTemplate({ label, price }) {
  ...
  return {
    ...
    html: shell({
      ...
      bodyHtml: `Thanks for upgrading. Your plan: ${planLine}.<br><br>Everything's unlocked — <b>200 credits a month, which is 20 videos</b>, AI chats, re-edit any finished video, and upload up to 10 at once.<br><br>You can view or change your subscription anytime in your Apple account.`,
