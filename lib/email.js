...
function purchaseTemplate({ label, price }) {
  ...
  return {
    ...
    html: shell({
      ...
      bodyHtml: `Thanks for upgrading. Your plan: ${planLine}.<br><br>Everything's unlocked — <b>unlimited video edits</b>, unlimited AI chats, re-edit any finished video, upload up to 10 at once, and a priority render queue.<br><br>You can view or change your subscription anytime in your Apple account.`,
