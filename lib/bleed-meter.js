...
function formatDigest(d, commerce, degen, languages, pushes, tiers, lumen, defects) {
...
async function maybeRunBleedMeter(supabaseAdmin, opts = {}) {
  ...
  const { title, body } = formatDigest(digest, commerce, degen, languages, pushes, tiers, lumen, defects);
