...
const SFX_LIBRARY_FILES = {
  whoosh: ['whoosh_1.mp3', 'whoosh_2.mp3', 'whoosh_3.mp3'],
  slide: ['slide_1.mp3', 'slide_2.mp3'],
  impact: ['impact_1.mp3', 'impact_2.mp3'],
  pop: ['pop_1.mp3', 'pop_2.mp3', 'pop_3.mp3'],
  ding: ['ding_1.mp3', 'ding_2.mp3'],
  click: ['click_1.mp3', 'click_2.mp3'],
  ching: ['ching_1.mp3', 'ching_2.mp3'],
};
...
function defaultTransitionSfxStyle(transition) {
  ...
  if (t.includes('wipe') || t.includes('smooth')) return 'slide';
  if (t.includes('zoom')) return 'whoosh';
  if (t.includes('fade') || t.includes('dissolve')) return 'whoosh';
  return 'whoosh';
}
