...
function buildColorFilters(colorGrade) {
  ...
  // Quality enhancement filters — applied to every clip
  // Light denoise first (cleans up source noise before sharpening amplifies it)
  filters.push('hqdn3d=2:1.5:2:3');
  // Sharpening — the biggest visual impact for "enhanced quality" feel
