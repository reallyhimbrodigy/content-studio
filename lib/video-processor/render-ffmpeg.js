...
const OVERLAY_FONT_PATH = '/opt/render/project/src/assets/fonts/Montserrat-Black.ttf';
const OVERLAY_FONT_LOCAL_PATH = path.join(__dirname, '..', '..', 'assets', 'fonts', 'Montserrat-Black.ttf');
