 ...
 * @returns {string}
 */
export function mapCaptionAnimation(animation) {
 ...
 * @returns {object}
 */
export function buildShotstackTimeline(clipAnalysis, editRecipe, videoUrl, sfxAssets = []) {
 ...
 */
export async function submitToShotstack(timeline) {
 ...
 */
export async function pollShotstackRender(renderId) {
  if (!process.env.SHOTSTACK_API_KEY) {
