...
const NO_SPEECH_COPY =
  "We couldn't hear any speech in this video. Promptly edits talking videos — upload a clip of someone speaking to the camera.";
const NO_SPEECH_MIC_COPY =
  "We couldn't pick up clear speech — if you were talking, check your mic isn't muted, then try again.";
