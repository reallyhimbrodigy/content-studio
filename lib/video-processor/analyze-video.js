...
A "shot" is any continuous, unedited segment of footage. Every time there is a visible cut — whether the scene changes, the angle changes, or the same speaker jump-cuts to a slightly different position — that is a new shot. Report every single one.
...
The shots array must span from 0.000 to the end of the video with no gaps. Focus on visual accuracy — every shot change, every shift in framing or content.`;
}
