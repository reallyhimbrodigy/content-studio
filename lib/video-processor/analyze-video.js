...
async function getAnalysis(videoId) {
  ...
  try {
    ...
    formData.append('query_text', "Describe every shot in detail including visual content, motion, energy, and timing");
    formData.append('query_media_type', 'text');
    ...
    console.log('  Search payload:', JSON.stringify({
      index_id: indexId,
      query_text: "Describe every shot in detail including visual content, motion, energy, and timing",
