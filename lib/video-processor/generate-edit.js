...
Frame thumbnails with timestamps are attached as image blocks.
...
Speed on short-form: Speed changes between 1.0x and 1.15x are imperceptible to viewers on talking-head content — the speech sounds natural but the pacing feels tighter. Above 1.2x, viewers start to notice the speed increase. Below 0.9x, slow motion is visible and reads as dramatic emphasis. On screen recordings and demos, speeds up to 1.25x work because viewers are watching visual content rather than listening to speech cadence.
