...
Read the speech from start to finish. That's the content. Understand the speaker's message and how each part builds on the last.

Cut this into a finished social media video. Use the sentence endings and cut points above as your edit points — they mark the silences between words where cuts will be invisible.

Break the edit into clips at sentence boundaries — each clip should cover one thought or one sentence. This is a social media video; short clips keep the energy up.

Place a transition at every cut point. The client asked for transitions — deliver them.

Only cut content that is repetitive, weak, or doesn't serve the message. If the content is strong throughout, keep it all. Don't cut good material just to shorten the video.

When you remove a section, the speech from the clip before and the clip after will play back to back. Make sure they connect naturally. If they don't, adjust your cuts.

You have these transitions available: clean_cut, fade, fadeblack, fadewhite, dissolve, wipeleft, wiperight, wipeup, wipedown, wipetl, wipetr, wipebl, wipebr, slideleft, slideright, slideup, slidedown, smoothleft, smoothright, smoothup, smoothdown, circlecrop, rectcrop, circleclose, circleopen, horzclose, horzopen, vertclose, vertopen, diagbl, diagbr, diagtl, diagtr, hlslice, hrslice, vuslice, vdslice, pixelize, radial, hblur, squeezeh, squeezev, zoomin, distance. The client brief is what you're serving.
