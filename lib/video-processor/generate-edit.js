...
Cut-zoom:
  true — alternates between normal and slightly zoomed framing at sentence boundaries within the clip. This is one of the most impactful editing techniques for talking-head content — it creates the appearance of a multi-camera shoot from a single take.
  false — no cut-zoom, use standard framing. Best for clips with lots of motion, screen recordings, or non-talking-head content.
...
Text overlays:
  ...
  Shorter text has more visual impact on mobile — punchy headlines read better than full sentences.
