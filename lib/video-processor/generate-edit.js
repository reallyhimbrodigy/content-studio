...
Rewrite this in 1-2 sentences so an editor can act on it immediately.
Keep the client's intent exactly. Do not add new goals, style directions, or embellishment.
If wording is vague, clarify what it means in editing terms while staying faithful to what they asked.
...
function buildPrompt(analysis, transcript, vibe) {
  ...
  These values represent what the footage needs to look clean and corrected. Use them as your starting point, then adjust based on the client's creative direction.`;
  }
...
This is the job. Every cut, transition, and color decision you make should deliver on this direction. The client will watch the final video and judge whether you delivered what they asked for.
...
The color baseline above was measured from the actual footage. It represents what the footage needs to look clean and corrected at neutral. Start from those values and adjust based on what the client asked for.
