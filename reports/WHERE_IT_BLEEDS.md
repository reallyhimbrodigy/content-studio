...
**JUDGE, generated 2026-08-15T00:46:59.870Z by `scripts/bleeds.js`.** Job window 24h; funnel + fulfillment windows stated per section. Every line [MEASURED].
...
| `A envelope FULL` | 77 | 77 | **58s** | 158s | 541s |

Worst/best class p50 spread: **15.5x** — the pooled number above hides it.

**ENVELOPE LOSS: 46.9% of completions (68/145), 56 users.** Regression BORN 2026-08-11T23Z after 8 clean days at 0.0% (08-04..08-11). The pooled p50 above sits between classes and describes NO actual user.
...
|---|---:|---:|---:|---:|
| **QUEUE** (create→worker pickup) | 51.0s | 347.7s | 757.4s | 824.3s |
| **WORK** (pickup→complete) | 84.0s | 304.0s | 697.9s | 801.7s |

Queue is **33%** of e2e at p50; **51.0%** of jobs wait >30s before any work begins.
...
On the 900s wall [870,920]: **5** of 145

## 3. Route mix (24h)

`none` 68 · `minimal` 48 · `minimal_speech_uncut` 28 · `moodreel` 1

Premium share: **0.7%** (1/145).

## 4. Delivery layer — since the column landed 2026-08-11T19:50:15Z (n=183 terminal)

`reconciler` 140 · `repair` 6 · `NULL` 36 · `callback` 1
...
wall_viewed **1562** → started **125** (8.0%) → paid **2** (1.6% of starters)
purchase_failed n=262, self-cancelled at the sheet **258** (98.5%) — the leak is the OFFER, not the funnel.
