...
| last 7d | prior 7d | change | peak (2026-08-04) | last full day (2026-08-22) | peak → now |
|---:|---:|---:|---:|---:|---:|
| **188/day** | 213/day | **-12%** | 861 | **126** | **-85%** |

**This sits above the failure rate because a rate on a shrinking denominator flatters itself.** A 10% failure rate over 126 makers is a worse product than 10% over 861, and only this line can tell them apart. Today is excluded as a partial day.
...
_**Second-order, and stated every time:** paywall work sits behind delivery. 3,791 users saw a paywall against a **39.1%** delivery rate — a user who never received a video is not a user a paywall can convert._
