...
| `A envelope FULL` | 79 | 79 | **58s** | 116s | 541s |

Worst/best class p50 spread: **15.5x** — the pooled number above hides it.

**ENVELOPE LOSS: 44.4% of completions (63/142), 51 users.** Regression BORN 2026-08-11T23Z after 8 clean days at 0.0% (08-04..08-11). The pooled p50 above sits between classes and describes NO actual user.
...
On the 900s wall [870,920] — count: **5** of 142

## 3. Route mix (24h)

`none` 63 · `minimal` 48 · `minimal_speech_uncut` 29 · `moodreel` 2

Premium share: **1.4%** (2/142).

## 4. Delivery layer — since the column landed 2026-08-11T19:50:15Z (n=179 terminal)

`reconciler` 132 · `repair` 6 · `NULL` 35 · `callback` 5 · `durable_poll` 1
