...
///
/// RESTORED 2026-09-23 (ruled): the intro offer is its OWN screen again, shown
/// on decline or dismiss, not conjoined with the paywall rows. Both firings
/// spend from `ExitOffer`'s shared budget, so the cap holds across them.
